...
public plugin_init()
{
	...
	register_concmd("amx_reloadadmins", "cmdReload", RANK_CO_OWNER)
	register_concmd("amx_addadmin", "addadminfn", RANK_CO_OWNER, "<playername|auth> <accessflags> [password] [authtype] - add specified player as an admin to users.ini")
