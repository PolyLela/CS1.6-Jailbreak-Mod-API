...
public plugin_init()
{
	...
	register_concmd("amx_kick", "cmdKick", RANK_ADMIN, "<name or #userid> [reason]")
	register_concmd("amx_ban", "cmdBan", RANK_FULL_ADMIN, "<name or #userid> <minutes> [reason]")
	register_concmd("amx_banip", "cmdBanIP", RANK_FULL_ADMIN, "<name or #userid> <minutes> [reason]")
	register_concmd("amx_addban", "cmdAddBan", RANK_ADMINISTRATOR, "<^"authid^" or ip> <minutes> [reason]")
	register_concmd("amx_unban", "cmdUnban", ADMIN_BAN|ADMIN_BAN_TEMP, "<^"authid^" or ip>")
	register_concmd("amx_slay", "cmdSlay", RANK_ADMIN, "<name or #userid>")
	register_concmd("amx_slap", "cmdSlap", RANK_ADMIN, "<name or #userid> [power]")
	register_concmd("amx_leave", "cmdLeave", RANK_OWNER, "<tag> [tag] [tag] [tag]")
	register_concmd("amx_pause", "cmdPause", RANK_OWNER, "- pause or unpause the game")
	register_concmd("amx_who", "cmdWho", RANK_ADMINISTRATOR, "- displays who is on server")
	register_concmd("amx_cvar", "cmdCvar", RANK_OWNER, "<cvar> [value]")
	register_concmd("amx_xvar_float", "cmdXvar", RANK_ADMINISTRATOR, "<xvar> [value]")
	register_concmd("amx_xvar_int", "cmdXvar", RANK_ADMINISTRATOR, "<xvar> [value]")
	register_concmd("amx_plugins", "cmdPlugins", RANK_OWNER)
	register_concmd("amx_modules", "cmdModules", RANK_OWNER)
	register_concmd("amx_map", "cmdMap", RANK_CO_OWNER, "<mapname>")
	register_concmd("amx_extendmap", "cmdExtendMap", RANK_CO_OWNER, "<number of minutes> - extend map")
	register_concmd("amx_cfg", "cmdCfg", RANK_CO_OWNER, "<filename>")
	register_concmd("amx_nick", "cmdNick", RANK_ADMIN, "<name or #userid> <new nick>")
	register_concmd("amx_last", "cmdLast", RANK_ADMINISTRATOR, "- list the last few disconnected clients info");
	register_clcmd("amx_rcon", "cmdRcon", RANK_OWNER, "<command line>")
	register_clcmd("amx_showrcon", "cmdShowRcon", RANK_OWNER, "<command line>")
...
public cmdUnban(id, level, cid)
{
	...
	if( !(hasRank(id, RANK_ADMINISTRATOR)) )
	{
