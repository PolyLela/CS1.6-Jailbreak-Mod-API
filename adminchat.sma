...
public plugin_init()
{
	...
	register_clcmd("say", "cmdSayChat", RANK_ADMIN, "@[@|@|@][w|r|g|b|y|m|c]<text> - displays hud message", 1) // forces FlagManager as it is a say command
	register_clcmd("say_team", "cmdSayAdmin", 0, "@<text> - displays message to admins")
	register_concmd("amx_say", "cmdSay", RANK_ADMIN, "<message> - sends message to all players")
	admin_chat_id = register_concmd("amx_chat", "cmdChat", RANK_ADMIN, "<message> - sends message to admins")
	register_concmd("amx_psay", "cmdPsay", RANK_ADMIN, "<name or #userid> <message> - sends private message")
	register_concmd("amx_tsay", "cmdTsay", RANK_ADMIN, "<color> <message> - sends left side hud message to all players")
	register_concmd("amx_csay", "cmdTsay", RANK_ADMIN, "<color> <message> - sends center hud message to all players")
