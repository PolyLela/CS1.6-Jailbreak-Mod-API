...
public plugin_init()
{
	...
	register_concmd("amx_ban", "CmdBan", RANK_FULL_ADMIN, "<nick, #userid, authid> <time in minutes> <reason>");
	register_concmd("amx_banip", "CmdBanIp", RANK_FULL_ADMIN, "<nick, #userid, authid> <time in minutes> <reason>");
	register_concmd("amx_addban", "CmdAddBan", RANK_CO_OWNER, "<name> <authid or ip> <time in minutes> <reason>");
	register_concmd("amx_unban", "CmdUnban", RANK_ADMINISTRATOR, "<authid or ip>");
	register_concmd("amx_banlist", "CmdBanList", RANK_FULL_ADMIN, "[start] -- shows everyone who is banned");
